...
describe('Write object records into CSV', function () {
    ...
    describe('When only header ids are given', function () {
        var filePath = makeFilePath('minimum');
        var writer;
        beforeEach(function () {
            writer = index_1.createObjectCsvStringifier({
                header: ['name', 'lang']
            });
        });
    ...
    describe('When header ids are given with reverse order', function () {
        ...
        var writer = index_1.createObjectCsvStringifier({
            header: ['lang', 'name']
        });
...
//# sourceMappingURL=stringify-object-records.js.map